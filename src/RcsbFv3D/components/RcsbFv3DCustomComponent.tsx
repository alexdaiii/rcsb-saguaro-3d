...
export class RcsbFv3DCustomComponent<R, L, S> extends React.Component<
  RcsbFv3DCustomComponentProps<R, L, S>,
  RcsbFv3DCustomComponentState<R, L, S>
> {
  ...
  render(): JSX.Element {
    return (
      ...
      >
        <div
          id={this.ROOT_DIV_ID}
          style={RcsbFv3DCustomComponent.mainDivCssConfig(
  ...
  private subscribe(): Subscription {
    return this.props.ctxManager.subscribe(
      (obj: RcsbFvCustomContextManagerInterface<R, L, S>) => {
        if (obj.eventType == EventType.UPDATE_CONFIG) {
          this.updateConfig(
            obj.eventData as CustomUpdateConfigInterface<R, L, S>,
          );
  ...
  private updateConfig(config: CustomUpdateConfigInterface<R, L, S>) {
