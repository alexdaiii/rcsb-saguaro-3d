...
export class RcsbFvSequence<T, U> extends React.Component<
  RcsbFvSequenceInterface<T, U> & {
...
> {
  render() {
    const config: RcsbViewInterface<T, U> = this.props
      .config as unknown as RcsbViewInterface<T, U>;
    return (
      <RcsbView<T, U>
        {...config}
