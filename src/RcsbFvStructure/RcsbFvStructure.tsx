...
export class RcsbFvStructure<R, L, S> extends React.Component<
  RcsbFvStructureConfigInterface<R, S> &
    RcsbFvStructureAdditionalInterface<R, L, S>,
  RcsbFvStructureConfigInterface<R, S>
> {
  render(): JSX.Element {
    return (
      <div id={this.props.componentId + "_" + RcsbFvDOMConstants.MOLSTAR_DIV}>
        <div
          id={RcsbFvStructure.componentId(this.props.componentId)}
  ...
  async componentDidMount() {
    ...
    this.props.structureViewer.init(
      this.props.stateManager,
      this.props.structureViewerConfig,
    );
    this.props.structureViewerBehaviourObserver.observe(
  ...
  private updateDimensions(): void {
    const div: HTMLElement | undefined | null = document.getElementById(
      this.props.componentId + "_" + RcsbFvDOMConstants.MOLSTAR_DIV,
    )?.parentElement;
    if (div == null) return;
    const rect: DOMRect = div.getBoundingClientRect();
    RcsbFvStructure.setSize(
    ...
    RcsbFvStructure.setSize(
      document.getElementById(
        this.props.componentId + "_" + RcsbFvDOMConstants.MOLSTAR_APP_ID,
      ),
      rect,
    );
  }
