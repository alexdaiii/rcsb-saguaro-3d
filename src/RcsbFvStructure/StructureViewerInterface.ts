...
export type SaguaroPluginModelMapType = Map<
  string,
...
export interface StructureViewerInterface<R, L, S>
  extends StructureViewerPublicInterface<R, L>,
    ViewerCallbackManagerInterface {
  init: (stateManager: RcsbFvStateInterface, args: S) => void;
}

export interface StructureViewerPublicInterface<R, L>
  extends ViewerActionManagerInterface<R, L> {}
